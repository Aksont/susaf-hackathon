...
export default function CredentialsForm(props: { handleSubmitProps: () => void }) {
  ...
  const handleSubmit = (e: { preventDefault: () => void }) => {
    ...
    console.log("Basic " + `${btoa(`${formData.email}:${formData.jiraAPIKey}`)}`);
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            name="email"
            id="email"
            value={context?.credential.email}
        ...
        <div>
          ...
          <input
            ...
            name="jiraURL"
            id="jiraURL"
            value={context?.credential.jiraURL}
            onChange={handleChange}
            required
            className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
          />
        ...
        <div>
          ...
          <input
            ...
            name="jiraAPIKey"
            id="jiraAPIKey"
            value={context?.credential.jiraAPIKey}
            onChange={handleChange}
            required
            className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
          />
        ...
        <div>
          ...
          <input
            ...
            name="miroBoardID"
            id="miroBoardID"
            value={context?.credential.miroBoardID}
            onChange={handleChange}
            required
            className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
          />
